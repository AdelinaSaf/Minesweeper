...
Это многопользовательская сетевая версия классической игры "Сапёр", реализованная на Java. Проект поддерживает одновременную игру двух игроков на одном игровом поле с системой рейтинга и сохранением результатов.
